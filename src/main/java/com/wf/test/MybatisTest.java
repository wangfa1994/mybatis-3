...
public class MybatisTest {
  ...
  public static void findByIdOld() throws IOException {
    InputStream resourceAsStream = Resources.getResourceAsStream("demo/sqlMapConfig.xml");
    ...
    // 通过sql
    User user = (User)sqlSession.selectOne("com.wf.dao.IUserDao.findById", 1);
    System.out.println(user);
    sqlSession.close();
  }

  public static void selectListAll() throws IOException {
    InputStream resourceAsStream = Resources.getResourceAsStream("demo/sqlMapConfig.xml");
    SqlSessionFactory sqlSessionFactory = new SqlSessionFactoryBuilder().build(resourceAsStream);
    SqlSession sqlSession = sqlSessionFactory.openSession();
    // 通过sql
    List<Object> objects = sqlSession.selectList("com.wf.dao.IUserDao.findAll");
